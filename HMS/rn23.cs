...
namespace HMS
{
    public partial class rn23 : Form
    {
        public rn23()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "INSERT INTO rn23([name],[in],[out],[person],[day]) values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "');";
