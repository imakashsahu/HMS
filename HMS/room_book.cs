...
namespace HMS
{
    public partial class room_book : Form
    {
        public room_book()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "INSERT INTO rn1([name],[in],[out],[person],[day]) values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "');";
