...
namespace HMS
{
    public partial class food_a : Form
    {
        public food_a()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "INSERT INTO food([c_name],[i_name],[quantity],[price]) values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "');";
