...
namespace HMS
{
    public partial class m_pay : Form
    {
        public m_pay()
        {
            InitializeComponent();
        ...
        private void m_pay_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "INSERT INTO income([value],[reason]) values('" + textBox1.Text + "','" + textBox3.Text + "');";
