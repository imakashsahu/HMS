...
namespace HMS
{
    public partial class rn22 : Form
    {
        public rn22()
        {
            InitializeComponent();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Query = "INSERT INTO rn22([name],[in],[out],[person],[day]) values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "');";
